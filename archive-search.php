    ...
    <body>
        ...
        <div class="u-grid">
            <header class="l-header">
                <div class="c-inner">
                    ...
                    <div class="l-header__section">
                        ...
                        <input type="submit" name="submit" class="p-search__button" value="検索">
                        </form>
                    </div>
                </div><!--.c-inner-->
            </header>
            ...
            <main class="u-grid__main">
                <div class="p-main-visual--archive-search">
                    <img class="c-main-bg" src="mainvisual-img/page-title_archive.png" alt="">
                    <h2 class="c-title--textline__bg--search">Search:</h2>
                </div><!--.p-main-visual-->
                ...
                <div class="p-archive__section c-inner-archive">
                    <figure class="p-archive__card">
                        ...
                        <figcaption class="p-archive__item">
                            ...
                            <button><a href="shingle.html">詳しく見る</a></button>
                        </figcaption>
                    </figure>
